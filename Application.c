...
int main(int argc, char *argv[])
{
	...
	SetCtrlAttribute(freqHandle, PANEL_2_NEXT_3, ATTR_DIMMED, 1);
    SetCtrlAttribute(freqHandle, PANEL_2_PREV_3, ATTR_DIMMED, 1);
                       ...
                       void *callbackData, int eventData1, int eventData2)
{
    ...
    case EVENT_COMMIT:
        ...
        case 2:
            SetCtrlAttribute(freqHandle, PANEL_2_NEXT, ATTR_DIMMED, 1);
            SetCtrlAttribute(freqHandle, PANEL_2_PREV, ATTR_DIMMED, 1);
			SetCtrlAttribute(freqHandle, PANEL_2_NEXT_3, ATTR_DIMMED, 0);
            SetCtrlAttribute(freqHandle, PANEL_2_PREV_3, ATTR_DIMMED, 0);
